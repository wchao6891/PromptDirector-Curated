...
if (catalog?.format !== "prompt-director-curated" || catalog.version !== 1 || !Array.isArray(catalog.items)) {
...
for (const item of catalog.items) {
  const required = ["id", "title", "type", "packageId", "packageVersion", "author", "license", "updatedAt", "coverUrl", "downloadUrl", "sha256"];
...
process.stdout.write(`catalog.json 有效：${catalog.items.length} 个精选包\n`);
